...
5. **Modelando un Fidget Spinner**

    Es hora de hacer un ejercicio práctico en el que apliquemos lo visto hasta ahora:
    ...
    **Explicación a la solución propuesta**
    
    **Nota:** Se recomienda intentar resolver el ejercicio anterior antes de consultar la solución. 
        
        - Objetos y dimensiones
            1. Rodamientos: Cilindros de 11 mm de radio y 7 mm de altura.
            2. Spinner sin agujeros: Podemos construirlo como la unión de medio cilindro a la izquierda con un prisma y medio cilindro a la derecha. La anchura del Spinner deberá ser ligeramente superior al diámetro del rodamiento (2x11mm), por lo que podemos tomar 26 mm. El largo del prisma, como debe contener medio rodamiento a la derecha, un rodamiento en el centro y medio rodamiento a la izquierda, deberá ser ligeramente superior a dos veces el diámetro del rodamiento (2x22mm). Tomaremos, inicialmente 50mm.  
            3.Spinner con agujeros: A la pieza anterior deberemos quitarles 3 rodamientos. los exteriores centrados en los centros de los medios cilindros laterales del spinner, y el tercero en medio del prisma del spinner, por tanto centrado a 25 mm de cada uno de los anteriores.
        - Modelado del Spinner sin agujeros: Se unen el cilindro izquierdo con con el prisma y el cilindro derecho. Tomamos como criterio que el cilindro izquierdo lo centraremos en el eje de coordenadas. 
        - Modelado de los rodamientos: EL primer rodamiento quedará centrado en el origen de coordenadas y los otros dos despazados con una distancia entre ellos de 25 mm en el eje X
